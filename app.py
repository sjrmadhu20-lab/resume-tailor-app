...
# ==============================================================================
# 4. REPORTLAB ELEMENTS GENERATOR (CALIBRI RESUME & SUITE)
# ==============================================================================
def get_pdf_styles():
...
def get_resume_story(tailored_data, st_dict):
    ...
    story.append(HRFlowable(width="100%", thickness=0.75, color=colors.HexColor('#000000'), spaceBefore=2, spaceAfter=4))
